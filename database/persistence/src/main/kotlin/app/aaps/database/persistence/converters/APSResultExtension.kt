...
fun app.aaps.database.entities.APSResult.Algorithm.fromDb(): APSResult.Algorithm =
    when (this) {
        ...
        app.aaps.database.entities.APSResult.Algorithm.DYNAMIC  -> APSResult.Algorithm.DYNAMIC
...
fun APSResult.Algorithm.toDb(): app.aaps.database.entities.APSResult.Algorithm =
    when (this) {
        ...
        APSResult.Algorithm.DYNAMIC -> app.aaps.database.entities.APSResult.Algorithm.DYNAMIC
